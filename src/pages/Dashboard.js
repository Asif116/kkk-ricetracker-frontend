...
const Dashboard = () => {
  ...
  if (loading) {
    return <div data-testid="dashboard-loading" className="flex items-center justify-center h-96">Loading...</div>;
  }
    ...
    <div data-testid="dashboard-page" className="space-y-8">
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card data-testid="today-sales-card" className="bg-gradient-to-br from-green-50 to-emerald-50 border-green-200">
          ...
          <Card data-testid="today-expenses-card" className="bg-gradient-to-br from-red-50 to-rose-50 border-red-200">
            <CardHeader className="flex flex-row items-center justify-between pb-2">
          ...
          <Card data-testid="today-profit-card" className="bg-gradient-to-br from-blue-50 to-indigo-50 border-blue-200">
            <CardHeader className="flex flex-row items-center justify-between pb-2">
              ...
              {summary.best_sellers.map((product, idx) => (
                ...
                >
                  <div>
                    ...
                    <p className="text-sm text-gray-500">{product.quantity.toFixed(1)} kg sold</p>
                  </div>
