...
const Exports = () => {
  ...
  const handleExport = async (type, format) => {
    ...
    try {
      ...
      const res = await axios.post(`${API}${endpoint}`, { export_type: type }, {
        responseType: 'blob'
      });
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Card>
          ...
          <CardContent className="space-y-3">
            <p className="text-sm text-gray-600">Export all sales transactions with details</p>
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            <p className="text-sm text-gray-600">Export product list with pricing and stock</p>
            <div className="flex gap-2">
              <Button
